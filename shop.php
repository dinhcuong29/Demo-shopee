                ...
                <div class="row header_with_search">
                   ...
                   <div class="col-8">
                        <form action="shop.php" class="search" method = "post">
                            <input type="text" name="txt_search" class="input_search" placeholder="Shopee bao ship 0Đ - Đăng kí ngay!">
                                <button class=" btn_search" href="" name="btn_search" type="submit">
                    ...
                    <div class="col-2 gird_col_2">
                        <nav class="category">
                            <h3 class="category_heading">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="category_heading_icon" viewBox="0 0 16 16">
                            ...
                            <ul class="category_list">
                                <li class="category_item category_item_active">
                                    <a href="" class="category_item_link ">Điện thoại</a>
                                </li>
                                <li class="category_item ">
                                    <a href="" class="category_item_link ">Máy tính bảng</a>
                                </li>
                                <li class="category_item ">
                                    <a href="" class="category_item_link ">Pin dự phòng</a>
                                </li>
                                <li class="category_item ">
                                    <a href="" class="category_item_link ">Pin gắn trong,Cáp & bộ sạc</a>
                                </li>
                                <li class="category_item ">
                                    <a href="" class="category_item_link ">Ốp lưng,Miếng dán điện thoại</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
            <div class="col-10 gird_col_10">
                <div class="home_filter">
                    <span class="home_filter_lable ">Sắp Xếp Theo</span>
                    <button class="btn_f new">Phổ Biến</button>
                    <button class="btn_f ">Mới Nhất</button>
                    <button class="btn_f">Bán Chạy</button>
                    <div class="select_input">
                        <span class="select_lable">Giá</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16" style="margin-left: 200px;">
                            <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                        </svg>

                        <ul class="select_input_list">
                            <li class="select_input_item">
                                <a href="" class="select_input_link">Giá Thấp Đến Cao</a>
                            </li>
                            <li class="select_input_item">
                                <a href="" class="select_input_link">Giá Cao Đến Thấp</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="home_product">
                    <div class="row gird_row">
                        ...
                        if(isset($_POST["btn_search"])) {
                            ...
                            // Kiểm tra xem $txt_search có giá trị không
                            if(empty($txt_search)) {
                                echo "<h1 style='color:red;'> Vui lòng nhập sản phẩm bạn muốn tìm !</h1>";
                            } else {
                                $sql = "SELECT * FROM sanpham WHERE name LIKE '%" . $txt_search . "%'";
                                $result = mysqli_query($conn, $sql);
                                if($result) {
                                    while($row = mysqli_fetch_assoc($result)) {
                                        echo "<div class='col-3 gird_col_3'>";
                                            echo "<a href='chitietsp.php?id=" .$row['id']. "'  class= 'link_sp'>";
                                            echo "<div class='product_item'>";
                                            echo "<div class='product_item_img' style='background-image:url(admin/". $row["image"] .  ");'></div>";
                                            echo "<h3 class='product_item_name'>" .$row["name"]. "</h3>";
                                            echo "<div class='product_item_price'>";
                                            echo "<span class='price_old'>" .$row["price_old"]. ".000.000đ</span>";
                                            echo "<span class='price_current'>" .$row["price_current"]. ".000.000đ</span>";
                                            echo" </div>";
                                            echo '<div class="product_favorite">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16"><path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"/></svg>Yêu thích
                                                    </div>';
                                            echo "<div class='product_sale_off'>";
                                            echo "<span class='sale_off_persent'>" .$row["sale"]. "%</span>";        
                                            echo "<div class='sale_off_lable'>GIẢM</div>";    
                                            echo"</div>";
                                            echo "<div class='product_action'>";
                                            echo '<div class="action_star">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="#FFCE3E" class="bi bi-star-fill" viewBox="0 0 16 16"><path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/></svg>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="#FFCE3E" class="bi bi-star-fill" viewBox="0 0 16 16"><path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/></svg>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="#FFCE3E" class="bi bi-star-fill" viewBox="0 0 16 16"><path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/></svg>
                                                    <svg xmlns="http://www.w3.org/2000/svg"width="10" height="10" fill="#FFCE3E" class="bi bi-star-fill" viewBox="0 0 16 16"><path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/></svg>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="#FFCE3E" class="bi bi-star-half" viewBox="0 0 16 16"><path d="M5.354 5.119 7.538.792A.516.516 0 0 1 8 .5c.183 0 .366.097.465.292l2.184 4.327 4.898.696A.537.537 0 0 1 16 6.32a.548.548 0 0 1-.17.445l-3.523 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256a.52.52 0 0 1-.146.05c-.342.06-.668-.254-.6-.642l.83-4.73L.173 6.765a.55.55 0 0 1-.172-.403.58.58 0 0 1 .085-.302.513.513 0 0 1 .37-.245l4.898-.696zM8 12.027a.5.5 0 0 1 .232.056l3.686 1.894-.694-3.957a.565.565 0 0 1 .162-.505l2.907-2.77-4.052-.576a.525.525 0 0 1-.393-.288L8.001 2.223 8 2.226v9.8z"/></svg>
                                                </div>';
                                            echo "<span class='action_number'>Đã bán " .$row["sell"]. "k</span>";
                                            echo "</div>";
                                            echo "<div class='product_find'>Click để xem chi tiết</div>";
                                            echo" </div>";
                                            echo "<a>";
                                            echo "</div>";
                        ...
                        <ul class="pagination">
                            ...
                            <li class="pagination_item">
                                <a href="#" class="pagination_item_link pagination_item_action">1</a>
                            </li>
                            <li class="pagination_item">
                            ...
                            <li class="pagination_item">
                                <a href="#" class="pagination_item_link">5</a>
                            </li>
                            <li class="pagination_item">
