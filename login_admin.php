...
if(isset($_POST["login"])){
    ...
    $role = $_POST["role"];
    $_SESSION["role"] = $role;
    $sql = "select * from tbl_user where user = '".$user."' and password = '".$password."' and role = '".$role."' ";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if($role=="user_admin"){
            ...
            echo "Bạn không có quyền đăng nhập vào trang quản trị";
        }
    }
}
        ...
        <div class="modal_content">
            <div class="auth_form">
                <div class="header_form">
                    <div class="row">
                        <div class="col-4">
                            <p class="p_h" style="margin-top: 15px;">Đăng nhập</p>
                        </div>
                        <div class="col-6">
                            <img src="../images/dn1.png" alt="" width="110%" style="cursor: text;" >
                        </div>
                        <div class="col-2">
                            <a href="">
                                <img src="../images/dn2.png" alt="" width="100%" style="margin-top: 10px;">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="content_form">
                    <form action="login_admin.php" method="post" >
                        <input type="text" class="sdt" id="tk" placeholder="Email/Số điện thoại" name="txt_user">
                        <div class="ht">
                            <input type="password" id="password" placeholder="Mật khẩu" class="pass" name="txt_password">
                        ...
                        <input type="text" class="sdt" name = "role">     
                        <button class=" btn_h" type="submit" name="login">ĐĂNG NHẬP</button>
                    </form>
                    <script src="./js/dangnhap.js"></script>
                    <ul class="add_form">
                        <li><a href="" class="a_add a_m">Quên mật khẩu</a></li>
                        <li><a href="" class="a_add ">Đăng nhập với SMS</a></li>
                    </ul>
                ...
                <!-- <div class="footer_form">
                    ...
                    <a href="/php/shopee/dangki.php" class="a_ft">Đăng ký</a>
                </div>
                 -->
            </div>
        </div>
